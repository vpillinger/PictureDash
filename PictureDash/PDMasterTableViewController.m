...
#import "PDMasterTableViewController.h"
#import "Game.h"

@interface PDMasterTableViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation PDMasterTableViewController
...
- (void)insertNewObject:(id)sender
{
    ...
    [newManagedObject setValue:[NSDate date] forKey:@"dateStarted"];
...
{
    NSLog(@"Called Prepare for seque");
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"dateStarted" ascending:YES];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[object valueForKey:@"dateStarted"] description];
}
